...
public class EndSicknessContextMockFactory : IDbContextMockFactory<EndSicknessContext>
{
    public Mock<EndSicknessContext> Create()
    {
        ...
        var medicine2 = new Medicine("APAP", 3, 3, 6) { Id = 3, StatusId = 0, OwnerId = "secondUserId" };
        context.Medicines.Add(medicine2);

        var medicine3 = new Medicine("Nospa", 4, 3, 6) { Id = 4, StatusId = 1, OwnerId = "validUserId" };
        context.Medicines.Add(medicine3);

        var medicine4 = new Medicine("Ibuprom", 3, 3, 6) { Id = 5, StatusId = 1, OwnerId = "validUserId" };
        ...
        var log5 = new MedicineLog(medicine.Id, new DateTime(2023, 3, 12, 12, 0, 0)) { Id = 8, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log5);

        var log7 = new MedicineLog(medicine3.Id, new DateTime(2023, 1, 12, 12, 0, 0)) { Id = 10, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log7);
        var log8 = new MedicineLog(medicine3.Id, new DateTime(2023, 1, 12, 16, 20, 0)) { Id = 11, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log8);
        var log9 = new MedicineLog(medicine3.Id, new DateTime(2023, 1, 12, 20, 49, 0)) { Id = 12, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log9);

        var log10 = new MedicineLog(medicine4.Id, new DateTime(2023, 1, 1, 12, 0, 0)) { Id = 13, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log10);
        var log11 = new MedicineLog(medicine4.Id, new DateTime(2023, 1, 1, 20, 20, 0)) { Id = 14, StatusId = 1, OwnerId = "validUserId" };
        context.MedicineLogs.Add(log11);
        var log12 = new MedicineLog(medicine4.Id, new DateTime(2023, 1, 2, 11, 0, 0)) { Id = 15, StatusId = 1, OwnerId = "validUserId" };
